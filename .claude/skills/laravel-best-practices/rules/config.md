...
If the application already uses language files for localisation, use `__()` for user-facing strings too. Do not introduce language files purely for English-only apps — simple string literals are fine there.
