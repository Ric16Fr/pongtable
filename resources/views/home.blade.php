@php use App\Models\GameMatch;use App\Models\Tournament; @endphp
    <!DOCTYPE html>
    ...
    <header class="border-b border-stage-line" >
        <div class="mx-auto flex max-w-6xl items-center justify-between px-6 py-5 lg:px-10" >
            ...
            <nav class="flex items-center gap-2 text-sm" >
                ...
                @if (Tournament::publicScheduleVisible())
        ...
        <section class="flex flex-col gap-8" >
            @if ($tournament)
                ...
                <p class="max-w-xl text-base leading-relaxed text-stage-text-muted lg:text-lg" >
                    {{ $tournament->description ?: Tournament::DEFAULT_DESCRIPTION }}
                </p >
                ...
                <dl class="mt-6 flex flex-wrap items-baseline gap-x-10 gap-y-3 text-sm" >
                    ...
                    <div class="flex items-baseline gap-2" >
                        ...
                        <dd class="font-numeric text-xl font-semibold text-stage-text" >{{ $finishedCount }}<span
                                class="text-stage-text-dim" > / {{ $matchCount }}</span ></dd >
                    </div >
                </dl >
            @else
                ...
                <p class="max-w-xl text-base leading-relaxed text-stage-text-muted lg:text-lg" >
                    {{ Tournament::DEFAULT_DESCRIPTION }}
                </p >
                <div class="flex flex-wrap items-center gap-3 pt-2" >
                    @auth
