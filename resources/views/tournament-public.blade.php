...
<x-layouts::public :title="$tournament->name" :tournament="$tournament" >
    @php
        ...
        $startedAtMs = $tournamentStartedAt ? Carbon::parse($tournamentStartedAt)->getTimestampMs() : null;
            ...
            <section id="stats" class="space-y-6" >
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-6" >
                    ...
                    <div class="sm:col-span-6 flex items-baseline justify-between border-t border-stage-line pt-5" >
                        ...
                        <span
                            class="font-numeric text-3xl font-semibold text-stage-text lg:text-4xl" >{{ $stats['total_cups'] ?? 0 }}</span >
                    </div >
                </div >
            </section >
        @endif
